package com.example.composenoteapp.repository

import com.example.composenoteapp.data.NoteDatabaseDao
...
class NoteRepository @Inject constructor(private val noteDatabaseDao: NoteDatabaseDao) {
    ...
    suspend fun upsertNote(note: Note) = noteDatabaseDao.upsertNote(note = note)
